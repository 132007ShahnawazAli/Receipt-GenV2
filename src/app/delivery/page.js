...
function Delivery() {
    return (
        <div className="w-full flex tablet:flex-row flex-col gap-10 tablet:gap-0 justify-between tablet:pt-10 ">
            <h1 className=' font-semibold text-(--primary-text) text-5xl tablet:w-1/2 tablet:text-7xl tracking-tighter tablet:leading-20 '>Earn by promoting our products!</h1>
