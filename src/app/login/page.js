                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    required=""
                                    className="appearance-none rounded-md relative block w-full px-3 py-2 border border-(--secondary-text)/70 placeholder-(--secondary-text)/70 text-gray-900 focus:outline-none  focus:border-indigo-500 focus:z-10 sm:text-sm"
