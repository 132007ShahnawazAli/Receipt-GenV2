...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[var(--background)] text-[var(--primary-text)]">
      ...
      <div
        className={`fixed inset-y-0 left-0 z-30 w-64 transform bg-zinc-900 transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${
                ...
                return (
                  <NavItem
                    ...
                    className={`
                      ...
                      ${item.active ? "bg-[var(--accent-text)] text-zinc-900" : "text-gray-300 hover:bg-zinc-800"}
