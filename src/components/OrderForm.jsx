  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        ...
        <button onClick={onClose} className="cursor-pointer text-[var(--accent-text)] hover:text-[var(--accent-text)]/50">
          <X size={24} />
        </button>
      </div>
      ...
      {success ? (
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--primary-text)] mb-2">Delivery Address</label>
              <textarea
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--primary-text)] mb-2">Currency Symbol</label>
                <input
                  type="text"
                  name="currencySymbol"
