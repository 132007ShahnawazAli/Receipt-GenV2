...
function TutorialSection() {
    return (
        <div className=' border-b-[1px] border-gray-800 flex tablet:flex-row flex-col tablet:justify-between tablet:items-center tablet:py-10  h-fit gap-10 tablet:gap-0'>
