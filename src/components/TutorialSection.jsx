    ...
    return (
        <div className='tutorial-section border-b-[1px] border-gray-800 flex tablet:flex-row flex-col tablet:justify-between tablet:items-center tablet:py-10 pb-10 h-fit gap-10 tablet:gap-0'>
            <div className='flex flex-col gap-10'>
                ...
                <p className='tablet:text-2xl text-lg font-light tracking-tight text-(--primary-text) tablet:w-xl w-full  tablet:pt-10'>They are exclusively available on our HYPECEIPT generator. You definitely want to check it out!</p>
